...
- валидация гос.номера транспорта (х123хх123) Маска на госномер? = На работу Ноябрь.5-6
- валидация гос.номера прицепа (хх1234 123) Маска на госномер? = На работу Ноябрь.5-6
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
СОТРУДНИК:
- форму/маску на права (12 xx №123456)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
НАСТРОЙКИ:
