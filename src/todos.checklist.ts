...
17 - ЗАЯВКА: маршруты и расстояния, отображение и сохранение в бэк
   + отображение данных приёма заявки, корректировка и создание логики (отображение на карте)
...18 - подгрузка отдельно каждого сотрудника/прицепа/авто/+грузополуча/отправителя
...19 - отображение данных грузополучателя/грузоотправителя из данных самой заявки
*/
