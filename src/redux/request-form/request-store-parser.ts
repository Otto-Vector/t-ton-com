...
export const parseRequestFromAPI = ( {
    ...
    sender: {
        ...
        phisicalAddress: elem.phisicalAddressSender,
    ...
    recipient: {
        ...
        phisicalAddress: elem.phisicalAddressRecipient,
...
export const parseRequestToApiOnCreate = ( { userId, oneRequestValues, filteredContent, customerCard }: {
    ...
    return {
        ...
        phisicalAddressSender: oneRequestValues.sender.phisicalAddress || placeholderNull,
        ...
        phisicalAddressRecipient: oneRequestValues.recipient.phisicalAddress || placeholderNull,
