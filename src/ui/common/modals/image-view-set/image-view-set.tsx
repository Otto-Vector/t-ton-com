...
import {Preloader} from '../../tiny/preloader/preloader'
import styles from './image-view-set.module.scss'
import {AppStateType} from '../../../../redux/redux-store'
import {useDispatch, useSelector} from 'react-redux'
import {AttachImageButton} from '../../buttons/attach-image-button/attach-image-button'
...
export const ImageViewSet: React.ComponentType<OwnProps> = React.memo((
    {
        imageURL,
